            ...
            if (empty($ApiSicoobValidate->getErrors())) {
                ...
                */                  
                ...
                if(empty($ApiSicoob->getErrors())){
                    ...
                    $params->dataLimitePagamento =  date('Y-m-d', $Main->addDays($FinancialMovementsResult->movement_date_scheduled, 90)).'T00:00:00-03:00';// Adiciona 90 dias a partir da data do vencimento
                    ...
                    /** DADOS DA MULTA */
                    $params->tipoMulta =  2;//Percentual
                    $params->dataMulta =  date('Y-m-d', $Main->addDays($FinancialMovementsResult->movement_date_scheduled, 1)).'T00:00:00-03:00';
                    $params->valorMulta =  NULL;
                    $params->tipoJurosMora =  2;
                    $params->dataJurosMora = NULL;
                    $params->valorJurosMora =  NULL;
