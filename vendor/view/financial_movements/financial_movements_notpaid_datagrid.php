                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <h5 class="card-title">Movimentações Financeiras Em Aberto</h5>
                            ...
                            <table class="table table-bordered table-striped table-hover bg-white rounded shadow-sm table-sm" id="tableFinancialMovements" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <?php  
                                        ...
                                        $FinancialMovementsResult = $FinancialMovements->AllNotPaid($companyId);                                    
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="8">Total de movimentações: <?php echo $NumberRecords;?> - Total Geral R$ <?php echo number_format($total, 2, ',', '.');?></td>
                                    </tr>
                                </tfoot>                              
