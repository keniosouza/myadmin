...
if($Main->verifyToken()){
    ...
    $NumberRecords = $FinancialOutputs->Count()->qtde;
            ...
            <div class="card shadow mb-12">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered table-striped table-hover bg-white rounded shadow-sm table-sm" id="tableFinancialOutputs" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <?php  
                                    ...
                                    $FinancialOutputsResult = $FinancialOutputs->All($start, $max);
                                    foreach($FinancialOutputsResult as $FinancialOutputsKey => $Result){ 
                                ?>
                                    
                                    <tr>
                                        <td class="text-center" width="25"><?php echo $Result->financial_outputs_id;?></td>
                                        ...
                                        <td class="text-center" width="80"><?php echo number_format($Result->output_value, 2, ',', '.');?></td> 
                                        <td class="text-center" width="20"><button type="button" class="btn btn-primary btn-sm" onclick="request('FOLDER=view&TABLE=financial_outputs&ACTION=financial_outputs_form&financial_outputs_id=<?php echo $Result->financial_outputs_id;?>', '#loadContent', true, '', '', '', 'Preparando formulário', 'blue', 'circle', 'sm', true)"><i class="fas fa-edit mr-1"></i></button></td>
                                    </tr>                                 
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="9">
                                        ...
                                        <?php echo $Main->pagination($NumberRecords, $start, $max, $page, 'FOLDER=view&ACTION=financial_outputs_datagrid&TABLE=financial_outputs', 'Aguarde'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 text-right">
                            <h4>Não foram cadastradas saidas.</h4>
                        </div>
        
                        <div class="col-md-4 text-right">
        
                            <button type="button" class="btn btn-success btn-sm" onclick="request('FOLDER=view&TABLE=financial_outputs&ACTION=financial_outputs_form', '#loadContent', true, '', '', '', 'Preparando formulário', 'blue', 'circle', 'sm', true)">
        
                                <i class="fas fa-plus-circle mr-1"></i>Cadastrar nova saida
