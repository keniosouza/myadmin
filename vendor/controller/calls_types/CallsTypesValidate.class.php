...
namespace vendor\controller\calls_types;

/** Importação de classes */
use \vendor\model\Main;

class CallsTypesValidate
{
    ...
    public function setCallTypeId(int $call_type_id) : void
    {

        /** Tratamento dos dados de entrada */
        $this->call_type_id = isset($call_type_id) ? $this->main->antiInjection($call_type_id) : 0;
