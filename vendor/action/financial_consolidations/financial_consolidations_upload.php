            ...
            if( is_file($DocumentsValidate->getDirTemp().'/'.$DocumentsValidate->getDirUser().'/'.$DocumentsValidate->getName()) ){
                ...
                for($i=0; $i<count($dataT->T->numeroDocumento); $i++){ 
                    ...
                    if( !$dataU->U->valorPago[$i] ){
                        ...
                        $rowNotPaid .= '    <td class="text-center">'.$dataU->U->dataDaOcorrencia[$i].'</td>';                        ;                        
                        $rowNotPaid .= '</tr>';  
                    ...
                    /** Verifica se o título foi localizado */
                        ...
                        if(!empty($FinancialMovementsResults->movement_date_paid)){
                            ...
                            if(empty($FinancialMovementsResults->sicoob_response)){
                                ...
                                $rowAlreadyLocatedCheck = '    <td class="text-center"><input class="checkOurNumber" id="checkOurNumber" name="checkOurNumber" value="'.$FinancialMovementsResults->financial_movements_id.'*'.(int)substr($dataT->T->nossoNumero[$i], 0, 10).'" type="checkbox" onclick=""/></td>';
                            
                            } else {

                                $rowAlreadyLocatedCheck = '    <td class="text-center"></td>';
                            }
                            
                            $rowAlreadyLocated .= $rowAlreadyLocatedCheck;
                            ...
                            $rowAlreadyLocated .= '    <td class="text-center">'.(int)substr($dataT->T->nossoNumero[$i], 0, 10).'</td>';
                            ...
                            $rowAlreadyLocated .= '    <td class="text-center">'.$dataU->U->dataDaOcorrencia[$i].'</td>';                        
                            ...
                            $rowLocated .= '    <td class="text-center">'.$dataU->U->dataDaOcorrencia[$i].'</td>';                        
                    ...
                    /** Caso o título não seja localizado */
                        ...
                        $rowNotFound .= '    <td class="text-center">'.$dataU->U->dataDaOcorrencia[$i].'</td>';                        
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <table id="tableLocated" class="table table-bordered table-striped table-hover bg-white rounded shadow-sm table-sm" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Vlr. Pago</th>                                                    
                                ...
                                <div class="tab-pane fade " id="pills-4" role="tabpanel" aria-labelledby="pills-4-tab"> 
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="tableAlreadyConsolidated" class="table table-bordered table-striped table-hover bg-white rounded shadow-sm table-sm" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th class="text-center"></th>
                                                    <th class="text-center">Consolidação</th>
                                                    <th class="text-center">Sacado</th>
                                                    <th class="text-center">Sicoob</th>
                                                    <th class="text-center">Nosso Número</th>
                                                    <th class="text-center">Vencimento</th>
                                                    <th class="text-center">Valor(R$)</th>
                                                    <th class="text-center">Vlr. Mora</th>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="11">
                                                        ...
                                                        <select id="checkAllCheckOurNumber" class="btn btn-light float-right mr-2" name="checkAllLocated">
                                                            <option selected>Selecione</option>
                                                            <option value="S">Marque os títulos</option>
                                                            <option value="N">Desmarque os títulos</option>
                                                        </select>
                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function(e) { 
                        ...
                        /** Ao clicar no checkbox de selecionar todos os itens da grid Itens não localizados  */
                        ...
                        /** Ao clicar no checkbox de selecionar todos os itens da grid Itens que não possuem boleto salvo  */
                        $('#checkAllCheckOurNumber').on('change', function(){
                            ...
                            if($(this).val() == 'S'){
                                ...
                                /** Marca todos os itens */
                                $('#tableAlreadyConsolidated .checkOurNumber').each(function(){

                                    $(this).prop("checked", true);

                                    ourNumber.push($(this).val());

                                });

                                /** Carrega a função de logout */
                                let funcSave = "request('TABLE=financial_movements&ACTION=financial_movements_save_ournumber&FOLDER=action&ourNumber="+ourNumber+"', '', true, '', 0, '', 'Enviando solicitação...', 'random', 'circle', 'sm', true)";

                                modalPage(true, 0, 0,   'Atenção', '<b>Deseja salvar o Nosso Número aos itens selecionados?</b>', '', 'question', funcSave);
